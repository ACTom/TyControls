...
def build():
    ...
    a("  published")
    a("    { Attribution for the bundled icons -- same as TTyLucideImageList.License. Read-only;")
    a("      the design-time editor pops the full ISC + MIT text (TyLucideLicense). }")
    ...
    a("end;")
    a("")
    a("function TTyLucideIconFont.GetLicense: string;")
    a("begin")
