...
def build():
    ...
    a("")
    a("  Usage is one line each way:")
    a("")
    a("      CharImage1.IconFont  := TyLucideFont;")
    a("      CharImage1.GlyphName := TyIconHouse;   { or just 'house' }")
    a("")
    a("  and any TTyIconFont whose FontFamily is 'lucide' resolves Lucide names without a")
    a("  Glyphs entry, because this unit registers a resolver on startup.")
    a("")
    ...
    if dropped:
        ...
        a("  }")
    a("")
    a("{ The shared icon font, created on first use and registered from the embedded bytes.")
    a("  Owned by this unit and freed at finalization -- do not free it. Check Available on the")
    a("  result if you want to know whether the registration actually took. }")
    a("function TyLucideFont: TTyIconFont;")
    a("")
    ...
    a("")
    a("uses")
    a("  Classes, SysUtils, base64, zstream;")
    a("")
    a("type")
    ...
    a("")
    a("function TyLucideFont: TTyIconFont;")
    a("var d: RawByteString;")
    a("begin")
    a("  if GFont = nil then")
    a("  begin")
    a("    GFont := TTyIconFont.Create(nil);")
    a("    d := DecodeFont;")
    a("    if d <> '' then")
    a("      GFont.LoadFontFromMemory(@d[1], Length(d), TyLucideFamily)")
    a("    else")
    a("      GFont.FontFamily := TyLucideFamily;")
    a("  end;")
    a("  Result := GFont;")
    a("end;")
    a("")
