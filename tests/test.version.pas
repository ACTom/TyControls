...
uses
  ...
  tyControls.AdvanceChart, tyControls.AnalogClock, tyControls.Arrow, tyControls.Badge, tyControls.BalloonHint,
...
initialization
  ...
  Reg([
    ...
    TTyBalloonHint, TTyPopover, TTyShape, TTyStarShape, TTyArrow, TTyChart, TTyAdvanceChart, TTyMessage,
