...
const
  ...
  CClasses: array[0..85] of string = (
    ...
    'TTyLabel','TTyEdit','TTyNumericEdit','TTyCurrencyEdit','TTyMaskEdit','TTyURLEdit','TTyComboEdit','TTyTrackEdit','TTyCheckBox','TTyRadioButton',
