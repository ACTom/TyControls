...
begin
  // The classic skin ships in themes/builtin/ (one level up from the test exe's tests/ dir).
  fn := ExtractFilePath(ParamStr(0)) + '..' + PathDelim + 'themes' + PathDelim
        + 'builtin' + PathDelim + 'classic.tycss';
