...
| [examples/grid](examples/grid/) | **TTyStringGrid**(6 个页签):冻结行列 / 百万行虚拟数据源 / 排序筛选分组 / 16 种编辑器 / 选择·剪贴板·撤销重做 / 事件钩子 |
