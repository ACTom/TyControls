...
uses
  ...
  tyControls.CircularProgress, tyControls.ActivityIndicator, tyControls.ToggleSwitch,
...
begin
  ...
  RegisterComponents('TyControls',
    [TTyButton, TTyLabel, TTyEdit, TTyCheckBox, TTyRadioButton,
     ...
     TTyListBox, TTyProgressBar, TTyGauge, TTyCircularProgress, TTyActivityIndicator,
