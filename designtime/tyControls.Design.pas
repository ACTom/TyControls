...
uses
  ...
  tyControls.ListBox, tyControls.ProgressBar, tyControls.Gauge, tyControls.ToggleSwitch,
...
begin
  ...
  RegisterComponents('TyControls',
    [TTyButton, TTyLabel, TTyEdit, TTyCheckBox, TTyRadioButton,
     ...
     TTyListBox, TTyProgressBar, TTyGauge, TTyToggleSwitch, TTyTrackBar, TTyGroupBox,
